<div class="modalreg w-full h-full fixed top-0 left-0 z-20 hidden">
    ...
    <div
        class="registrationform translate-y-28 z-50 bg-gradient-to-tr from-zinc-900 to-zinc-800 rounded-md shadow-sm shadow-neutral-500 w-[30rem] h-fit p-5 mx-auto flex justify-center items-center relative">
