<div class="GENRE ml-60 md:ml-64 lg:ml-80 xl:ml-60 w-full min-w-96 max-w-[30rem] md:max-w-[65rem] flex flex-col mt-10">
    <div class="flex flex-col items-center">
        <div class="w-full flex justify-between">
            ...
            <div class="mt-2">
                <button class="btn-add_genre text-nowrap p-3 bg-green-800 rounded-lg text-xs text-gray-200 flex justify-center items-center"
        ...
        <div class="w-full lg:w-[65rem] shadow-lg p-2 border border-slate-300">
            <table id="genre" class="display w-full">
                <thead>
                    <tr>
                        <th>Genre</th>
                    ...
                    @foreach ($genres as $genre)
                        <tr>
                            ...
                            <td class="flex justify-center gap-3">
                                <button type="button" class="btn-edit_genre_{{$genre->genre_id}}"
                                    aria-label="Edit genre for ">
                                    <i class="fa-regular fa-pen-to-square text-slate-700"></i>
                                </button>
                                <button type="button" class="btn-delete_genre_{{$genre->genre_id}}"
                                    aria-label="Delete genre for ">
...
@foreach ($genres as $genre)
<div class="modal-edit_genre_{{$genre->genre_id}} closeedit fixed inset-0 flex items-center justify-center z-30" style="display: none">
